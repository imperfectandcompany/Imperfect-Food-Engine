...
<header>
  <nav class="shadow items-center  md:pl-48 p-3 bg-green-500 text-white">
    <div x-data="{ open: false }" class="flex-1 md:flex">
      ...
      <a href="./">
          <div class=" md:flex-1 mr-2 text-white select-none font-bold">Food Engine - Log In</div>
        </a>
        ...
        <section>
            <form class="flex flex-col" method="POST">
                <div class="mb-6  rounded">
                    ...
                    <input type="text" id="emailoruser" name="login_emailoruser" value="" class="w-full text-gray-700 focus:outline-none border-b-4 border-gray-200 focus:border-green-600 transition duration-500 px-3 pb-3"/>
                </div>
                <div class="mb-6 pt-3 rounded ">
                    <label class="block text-gray-400 text-small font-bold mb-2 ml-3" for="password">Password</label>
                    <input type="password" id="password" name="login_password" value="" class="w-full text-gray-700 focus:outline-none border-b-4 border-gray-200 focus:border-green-600 transition duration-500 px-3 pb-3"/>
                </div>
                ...
                <button name="login" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 focus:outline-none rounded shadow-md hover:shadow-xl transition duration-200" type="submit">Log In</button>
            </form>
        </section>			
                <br>
                <hr>
			<section>
            <div class="flex flex-col max-w-lg mx-auto text-center mt-6">
                    <p class="text-gray-400 mb-6 font-semibold">Don't have an account?</p>
                <a href="./signup" class="border border-green-600 bg-white hover:bg-gray-100 hover:border-green-300 hover:text-gray-200 text-green-500 font-bold py-2 focus:outline-none rounded shadow-sm  transition duration-200">Create an Account</a>
                </div>
			</section>
    </main>
    <footer>

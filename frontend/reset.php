  ...
  <nav class="shadow items-center  md:pl-48 p-3 bg-green-500 text-white">
    <div x-data="{ open: false }" class="flex-1 md:flex">
      <div class="flex items-center flex-1">
        <a href="./">
          <div class=" md:flex-1 mr-2 text-white select-none font-bold">Food Engine - Reset</div>
        </a>
...
<?php if(isset($success)): ?>
  ...
  <a href="./greeneem"><p>DEMO greenEEM PAGE HERE.</p></a>
...
<?php endif; ?>
        ...
        <section>
            <form class="flex flex-col" name="resetpassword" method="POST">
                ...
                <button type="submit" name="resetpassword" value="Reset Password" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 focus:outline-none rounded shadow-md hover:shadow-xl transition duration-200">Send Email</button>
            </form>
        </section>			
                <br>
                <hr>
			<section>
                <div class="flex flex-col max-w-lg mx-auto text-center mt-12">
                    <p class="text-green-600 mb-6 font-bold">Already have a token?<a href="./redeem" class="font-normal text-green-500 pl-2 hover:text-green-700 hover:underline underline-none ml-1">Redeem</a></p>
                <a href="./login" class="border border-green-600 bg-white hover:bg-gray-100 hover:border-green-300 hover:text-gray-200 text-green-500 font-bold py-2 focus:outline-none rounded shadow-sm  transition duration-200">Go back</a>
                </div>
			</section>
    </main>	
    <footer>

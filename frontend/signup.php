  ...
  <nav class="shadow items-center  md:pl-48 p-3 bg-green-500 text-white">
    <div x-data="{ open: false }" class="flex-1 md:flex">
      <div class="flex items-center flex-1">
        <a href="./">
          <div class=" md:flex-1 mr-2 text-white select-none font-bold">Food Engine - Register</div>
        </a>
...
<?php endif; ?>
            ...
            <form class="flex flex-col" method="POST">
                <div class="mb-6 rounded">
                    ...
                    <input type="email" name="signup_email" aria-describedby="emailHelp"  value="<?php echo htmlspecialchars($_POST['signup_email'], ENT_QUOTES); ?>"
                           class="w-full text-gray-700 focus:outline-none border-b-4 border-gray-200 focus:border-green-600 transition duration-500 px-3 pb-3" />
                </div>
  ...
  <div class="relative w-full">
	...
	<input type="password" id="password" autocomplete="off" name="signup_password" class="w-full text-gray-700 focus:outline-none border-b-4 border-gray-200 focus:border-green-600 transition duration-500 px-3 pb-3"/>	
  </div>
                </div>
                <input type="hidden" name="form_type" value="new_user"/>	
                <button name="createaccount" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 focus:outline-none rounded shadow-md hover:shadow-xl transition duration-200" type="submit">Register</button>
            </form>
        </section>			
                <br>
                <hr>
            ...
            <div class="flex flex-col max-w-lg mx-auto text-center mt-6">
                    <p class="text-gray-400 mb-6 font-semibold">Already Have an Account?</p>
                <a href="./login" class="border border-green-600 bg-white hover:bg-gray-100 hover:border-green-300 hover:text-gray-200 text-green-500 font-bold py-2 focus:outline-none rounded shadow-sm  transition duration-200">Log In</a>
                </div>
			</section>
    </main>	
    <footer>
